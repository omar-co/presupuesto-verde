...
class Efecto extends ApexChartWidget
{
     ...
     * @var string
     */
    protected static string $chartId = 'ObjetivosAmbientalesEfecto';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Objetivos Ambientales por efecto ';
    ...
    {
        return ObjetivoAmbiental::select(['tipo_contribucion'])
